...
class Program
{
    ...
    {
        // Чтение данных
        ReadGeneticData("sequences1.txt");

        var commands = File.ReadAllLines("commands1.txt");
        ...
        File.WriteAllLines("genedata1.txt", outputLines);

        Console.WriteLine("Обработка завершена. Результаты записаны в genedata1.txt");
    }
